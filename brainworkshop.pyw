...
# generated by Brain Workshop """
CONFIGFILE_DEFAULT_CONTENTS += VERSION
CONFIGFILE_DEFAULT_CONTENTS += """
# 
...
try: JAEGGI_ADVANCE = config.getint('DEFAULT', 'JAEGGI_ADVANCE')
except: JAEGGI_ADVANCE = 90
try: JAEGGI_FALLBACK = config.getint('DEFAULT', 'JAEGGI_FALLBACK')
except: JAEGGI_FALLBACK = 75
...
try: ROLLOVER_HOUR = config.getint('DEFAULT', 'ROLLOVER_HOUR')
except: ROLLOVER_HOUR = 4
