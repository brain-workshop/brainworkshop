...
brain_icon.position = field.center_x - brain_icon.width//2, field.center_y - brain_icon.height//2
if cfg.BLACK_BACKGROUND:
...
brain_graphic.position = field.center_x - brain_graphic.width//2, field.center_y - brain_graphic.height//2 + 40
def scale_brain(dt):
